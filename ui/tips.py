...
TIP_CATEGORIES: tuple[TipCategory, ...] = (
    TipCategory(
        ...
        (
            ...
            Tip("Use -t movie, game, software, mobile, anime, or manga to choose a provider for direct CLI searches.", ("cli", "provider")),
            Tip("Need a desktop program? The Software provider searches The Pirate Bay Applications plus SolidTorrents; try -t software.", ("software", "apps", "cli")),
            Tip("Looking for an Android app? The Mobile provider searches The Pirate Bay's Android category (APK/MOD/OBB); it's Android-only. Try -t mobile.", ("mobile", "android", "cli")),
    ...
    TipCategory(
        ...
        (
            ...
            Tip("Manage OpenSubtitles, Addic7ed, and Jimaku logins in-app: Subtitle credentials on the Select Provider screen.", ("subtitles", "credentials", "provider")),
            Tip("OpenSubtitles.com credentials greatly improve subtitle matches; add them under Subtitle credentials.", ("subtitles", "credentials", "opensubtitles")),
