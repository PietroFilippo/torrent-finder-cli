...
TIP_CATEGORIES: tuple[TipCategory, ...] = (
    TipCategory(
        ...
        (
            ...
            Tip("RuTracker is great for software, audio, and rare content — add your rutracker.org login under Credentials, then try -t rutracker.", ("rutracker", "credentials", "cli")),
