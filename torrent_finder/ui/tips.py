...
TIP_CATEGORIES: tuple[TipCategory, ...] = (
    TipCategory(
        ...
        (
            ...
            Tip("Games is a group: pick General (public trackers) or Online-Fix (co-op / online game cracks from online-fix.me — no account needed; it saves the .torrent, opens your client, and shows the archive password).", ("games", "online-fix", "provider")),
